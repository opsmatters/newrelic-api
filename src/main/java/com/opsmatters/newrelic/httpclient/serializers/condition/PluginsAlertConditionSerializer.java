 ...
 */
public class PluginsAlertConditionSerializer implements JsonSerializer<PluginsAlertCondition>
{
     ...
     */
    @Override
    public JsonElement serialize(PluginsAlertCondition condition, Type type, JsonSerializationContext context)
    {
        JsonElement element = gson.toJsonTree(condition, type);
        JsonObject obj = new JsonObject();
        obj.add("plugins_condition", element);
        return obj;
    }
}
