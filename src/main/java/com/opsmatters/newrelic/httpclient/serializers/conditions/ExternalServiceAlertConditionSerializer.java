...
public class ExternalServiceAlertConditionSerializer implements JsonSerializer<ExternalServiceAlertCondition>
{
     ...
     */
    @Override
    public JsonElement serialize(ExternalServiceAlertCondition condition, Type type, JsonSerializationContext context)
    {
        JsonElement element = gson.toJsonTree(condition, type);
        JsonObject obj = new JsonObject();
        obj.add("external_service_condition", element);
        return obj;
    }
}
