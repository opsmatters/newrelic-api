...
public class MobileApplicationDeserializer implements JsonDeserializer<MobileApplication>
{
     ...
     */
    @Override
    public MobileApplication deserialize(JsonElement element, Type type, JsonDeserializationContext context)
        throws JsonParseException
    {
        JsonObject obj = element.getAsJsonObject();
        JsonElement application = obj.get("mobile_application");
        if(application != null && application.isJsonObject())
            return gson.fromJson(application, MobileApplication.class);
        return gson.fromJson(element, MobileApplication.class);
    }
}
