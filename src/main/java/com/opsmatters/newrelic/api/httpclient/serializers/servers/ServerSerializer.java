...
package com.opsmatters.newrelic.api.httpclient.serializers.servers;
...
public class ServerSerializer implements JsonSerializer<Server>
{
     ...
     * @param server The server being serialized
    ...
    {
        JsonElement element = gson.toJsonTree(server, type);
        JsonObject obj = new JsonObject();
        obj.add("server", element);
        return obj;
    }
}
