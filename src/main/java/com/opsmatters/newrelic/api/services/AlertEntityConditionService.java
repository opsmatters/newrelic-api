...
public class AlertEntityConditionService extends BaseFluent
{
     ...
     * @return This object
     */
    public AlertEntityConditionService remove(long entityId, String entityType, long conditionId)
    {
        QueryParameterList queryParams = new QueryParameterList();
        queryParams.add("entity_type", entityType);
        queryParams.add("condition_id", conditionId);
     ...
     * @return This object
     */
    public AlertEntityConditionService remove(Entity entity, long conditionId)
    {
