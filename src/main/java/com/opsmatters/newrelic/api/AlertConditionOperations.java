...
public class AlertConditionOperations extends BaseFluent
{
     ...
     */
    public AlertConditionOperations(HttpContext httpContext, NewRelicApiService apiService)
    {
    ...
    {
        return HTTP.PUT(String.format("/alerts_conditions/%d.json", condition.getId()), condition, ALERT_CONDITION);
    }
